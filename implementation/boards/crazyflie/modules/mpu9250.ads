...
package MPU9250 is
   ...
   --  Type representing all the different clock sources of the MPU9250.
   ...
   procedure MPU9250_Set_Full_Scale_Gyro_Range (FS_Range : MPU9250_FS_Gyro_Range);

   --  Set full-scale acceler range.
   procedure MPU9250_Set_Full_Scale_Accel_Range (FS_Range : MPU9250_FS_Accel_Range);
   ...
   procedure MPU9250_Set_Rate (Rate_Div : UInt8);
   ...
   --  Read raw 6-axis motion sensor readings (accel/gyro).
   ...
   --  Get raw 3-axis motion sensor readings (accelero).
   --  Retrieves all currently available motion sensor values.
   ...
   --  Get raw 3-axis motion sensor readings (gyro).
   --  Retrieves all currently available motion sensor values.
   ...
   --  Get last raw 6-axis motion sensor readings (accel/gyro).
   ...
   -- Get last raw accelerometer data
   procedure MPU9250_Get_Acc
     (Acc_X  : out Integer_16;
      Acc_Y  : out Integer_16;
      Acc_Z  : out Integer_16);

   -- Get last raw gyroscope data
   procedure MPU9250_Get_Gyro
     (Gyro_X : out Integer_16;
      Gyro_Y : out Integer_16;
      Gyro_Z : out Integer_16);
...
private
   ...
   Last_Acc_X : Integer_16 := 0;
   Last_Acc_Y : Integer_16 := 0;
   Last_Acc_Z : Integer_16 := 0;
   Last_Gyro_X : Integer_16 := 0;
   Last_Gyro_Y : Integer_16 := 0;
   Last_Gyro_Z : Integer_16 := 0;
