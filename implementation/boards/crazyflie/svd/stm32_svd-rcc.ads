...
package STM32_SVD.RCC is
   ...
   subtype CR_HSITRIM_Field is HAL_Type.UInt5;
   subtype CR_HSICAL_Field is HAL_Type.UInt8;
   ...
   type CR_Register is record
      ...
      CSSON          : Boolean := False;
      --  unspecified
      Reserved_20_23 : HAL_Type.UInt4 := 16#0#;
      --  Main PLL (PLL) enable
      PLLON          : Boolean := False;
      ...
      --  unspecified
      Reserved_28_31 : HAL_Type.UInt4 := 16#0#;
   end record
   ...
   subtype PLLCFGR_PLLM_Field is HAL_Type.UInt6;
   subtype PLLCFGR_PLLN_Field is HAL_Type.UInt9;
   subtype PLLCFGR_PLLP_Field is HAL_Type.UInt2;
   subtype PLLCFGR_PLLQ_Field is HAL_Type.UInt4;
   ...
   subtype CFGR_SW_Field is HAL_Type.UInt2;
   subtype CFGR_SWS_Field is HAL_Type.UInt2;
   subtype CFGR_HPRE_Field is HAL_Type.UInt4;
   --  CFGR_PPRE array element
   subtype CFGR_PPRE_Element is HAL_Type.UInt3;
   ...
   subtype CFGR_RTCPRE_Field is HAL_Type.UInt5;
   subtype CFGR_MCO1_Field is HAL_Type.UInt2;
   subtype CFGR_MCO1PRE_Field is HAL_Type.UInt3;
   subtype CFGR_MCO2PRE_Field is HAL_Type.UInt3;
   subtype CFGR_MCO2_Field is HAL_Type.UInt2;
   ...
   type CFGR_Register is record
      ...
      --  unspecified
      Reserved_8_9 : HAL_Type.UInt2 := 16#0#;
   ...
   type CIR_Register is record
      ...
      --  unspecified
      Reserved_14_15 : HAL_Type.UInt2 := 16#0#;
      ...
      --  unspecified
      Reserved_22_22 : HAL_Type.Bit := 16#0#;
      --  Write-only. Clock security system interrupt clear
      CSSC           : Boolean := False;
      --  unspecified
      Reserved_24_31 : HAL_Type.UInt8 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   type AHB1RSTR_Register is record
      ...
      --  unspecified
      Reserved_9_11  : HAL_Type.UInt3 := 16#0#;
      --  CRC reset
      CRCRST         : Boolean := False;
      --  unspecified
      Reserved_13_20 : HAL_Type.UInt8 := 16#0#;
      --  DMA2 reset
      DMA1RST        : Boolean := False;
      --  DMA2 reset
      DMA2RST        : Boolean := False;
      --  unspecified
      Reserved_23_24 : HAL_Type.UInt2 := 16#0#;
      --  Ethernet MAC reset
      ETHMACRST      : Boolean := False;
      --  unspecified
      Reserved_26_28 : HAL_Type.UInt3 := 16#0#;
      --  USB OTG HS module reset
      OTGHSRST       : Boolean := False;
      --  unspecified
      Reserved_30_31 : HAL_Type.UInt2 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   type AHB2RSTR_Register is record
      ...
      --  unspecified
      Reserved_1_5  : HAL_Type.UInt5 := 16#0#;
   ...
   type APB1RSTR_Register is record
      ...
      --  unspecified
      Reserved_9_10  : HAL_Type.UInt2 := 16#0#;
      --  Window watchdog reset
      WWDGRST        : Boolean := False;
      --  unspecified
      Reserved_12_13 : HAL_Type.UInt2 := 16#0#;
      --  SPI 2 reset
      SPI2RST        : Boolean := False;
      --  SPI 3 reset
      SPI3RST        : Boolean := False;
      --  unspecified
      Reserved_16_16 : HAL_Type.Bit := 16#0#;
      --  USART 2 reset
      ...
      --  unspecified
      Reserved_24_24 : HAL_Type.Bit := 16#0#;
      --  CAN1 reset
      CAN1RST        : Boolean := False;
      --  CAN2 reset
      CAN2RST        : Boolean := False;
      --  unspecified
      Reserved_27_27 : HAL_Type.Bit := 16#0#;
   ...
   type APB2RSTR_Register is record
      ...
      --  unspecified
      Reserved_2_3   : HAL_Type.UInt2 := 16#0#;
      --  USART1 reset
      USART1RST      : Boolean := False;
      --  USART6 reset
      USART6RST      : Boolean := False;
      --  unspecified
      Reserved_6_7   : HAL_Type.UInt2 := 16#0#;
      ...
      --  unspecified
      Reserved_19_31 : HAL_Type.UInt13 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   type AHB1ENR_Register is record
      ...
      CRCEN          : Boolean := False;
      --  unspecified
      Reserved_13_17 : HAL_Type.UInt5 := 16#0#;
      --  Backup SRAM interface clock enable
      BKPSRAMEN      : Boolean := False;
      --  unspecified
      Reserved_19_20 : HAL_Type.UInt2 := 16#2#;
      --  DMA1 clock enable
      ...
      --  unspecified
      Reserved_31_31 : HAL_Type.Bit := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   type AHB1LPENR_Register is record
      ...
      --  unspecified
      Reserved_13_14 : HAL_Type.UInt2 := 16#0#;
      ...
      --  unspecified
      Reserved_19_20 : HAL_Type.UInt2 := 16#0#;
   ...
   type AHB2LPENR_Register is record
      ...
      --  unspecified
      Reserved_1_5  : HAL_Type.UInt5 := 16#18#;
   ...
   type BDCR_Register is record
      ...
      --  unspecified
      Reserved_3_7   : HAL_Type.UInt5 := 16#0#;
      --  RTC clock source selection
      RTCSEL         : BDCR_RTCSEL_Field := (As_Array => False, Val => 16#0#);
      --  unspecified
      Reserved_10_14 : HAL_Type.UInt5 := 16#0#;
      --  RTC clock enable
      RTCEN          : Boolean := False;
      --  Backup domain software reset
      BDRST          : Boolean := False;
      --  unspecified
      Reserved_17_31 : HAL_Type.UInt15 := 16#0#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   type CSR_Register is record
      ...
      --  unspecified
      Reserved_2_23 : HAL_Type.UInt22 := 16#0#;
      --  Remove reset flag
      RMVF          : Boolean := False;
      --  BOR reset flag
   ...
   subtype SSCGR_MODPER_Field is HAL_Type.UInt13;
   subtype SSCGR_INCSTEP_Field is HAL_Type.UInt15;
   ...
   type SSCGR_Register is record
      ...
      --  unspecified
      Reserved_28_29 : HAL_Type.UInt2 := 16#0#;
      --  Spread Select
   ...
   subtype PLLI2SCFGR_PLLI2SNx_Field is HAL_Type.UInt9;
   subtype PLLI2SCFGR_PLLI2SRx_Field is HAL_Type.UInt3;
   ...
   type PLLI2SCFGR_Register is record
      ...
      --  unspecified
      Reserved_15_27 : HAL_Type.UInt13 := 16#0#;
