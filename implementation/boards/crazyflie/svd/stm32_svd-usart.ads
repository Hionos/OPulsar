...
package STM32_SVD.USART is
   ...
   type SR_Register is record
      ...
      LBD           : Boolean := False;
      --  unspecified
      Reserved_9_31 : HAL_Type.UInt23 := 16#6000#;
   end record
   ...
   subtype DR_DR_Field is HAL_Type.UInt9;
   ...
   subtype BRR_DIV_Fraction_Field is HAL_Type.UInt4;
   subtype BRR_DIV_Mantissa_Field is HAL_Type.UInt12;
   ...
   subtype CR2_ADD_Field is HAL_Type.UInt4;
   subtype CR2_STOP_Field is HAL_Type.UInt2;
   ...
   type CR2_Register is record
      ...
      --  unspecified
      Reserved_4_4   : HAL_Type.Bit := 16#0#;
      --  lin break detection length
      LBDL           : Boolean := False;
      --  LIN break detection interrupt enable
      LBDIE          : Boolean := False;
      --  unspecified
      Reserved_7_11  : HAL_Type.UInt5 := 16#0#;
      --  STOP bits
   ...
   type CR3_Register is record
      ...
      --  IrDA low-power
      IRLP           : Boolean := False;
      --  HAL_Type.-duplex selection
      HDSEL          : Boolean := False;
      --  unspecified
      Reserved_4_5   : HAL_Type.UInt2 := 16#0#;
      --  DMA enable receiver
      DMAR           : Boolean := False;
      --  DMA enable transmitter
      DMAT           : Boolean := False;
      --  unspecified
      Reserved_8_10  : HAL_Type.UInt3 := 16#0#;
   ...
   type SR_Register_1 is record
      ...
      CTS            : Boolean := False;
      --  unspecified
      Reserved_10_31 : HAL_Type.UInt22 := 16#3000#;
   end record
     with Volatile_Full_Access, Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype GTPR_PSC_Field is HAL_Type.UInt8;
   subtype GTPR_GT_Field is HAL_Type.UInt8;
