...
package STM32_SVD.GPIO is
   ...
   --  MODER array element
   subtype MODER_Element is HAL_Type.UInt2;
   ...
   subtype OSPEEDR_Element is HAL_Type.UInt2;
   ...
   --  PUPDR array element
   subtype PUPDR_Element is HAL_Type.UInt2;
   ...
   --  AFRL array element
   subtype AFRL_Element is HAL_Type.UInt4;
   ...
   --  AFRH array element
   subtype AFRH_Element is HAL_Type.UInt4;
