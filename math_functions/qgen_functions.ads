...
package Qgen_Functions is

   --  Function prototypes

   function pi return Long_Float;

   function eps return Long_Float;

   function Extract_8Bits (I, Offset : Unsigned_16) return Unsigned_8;
   function Extract_8Bits (I, Offset : Unsigned_32) return Unsigned_8;
   function Extract_8Bits (I, Offset : Integer_16) return Integer_8;
   function Extract_8Bits (I, Offset : Integer_32) return Integer_8;

   function Extract_16Bits (I, Offset : Unsigned_32) return Unsigned_16;
   function Extract_16Bits (I, Offset : Integer_32) return Integer_16;
   ...
   function Qgen_Shift_Left_U8 (Left, Right : Unsigned_32) return Unsigned_8;
   ...
   function Qgen_Shift_Left_S8 (Left, Right : Unsigned_32) return Integer_8;

   function Qgen_Shift_Right (Left, Right : Unsigned_8) return Unsigned_8;
   function Qgen_Shift_Right (Left, Right : Unsigned_16) return Unsigned_16;
   function Qgen_Shift_Right (Left, Right : Unsigned_32) return Unsigned_32;
   function Qgen_Shift_Right (Left, Right : Integer_8) return Integer_8;
   function Qgen_Shift_Right (Left, Right : Integer_16) return Integer_16;
   function Qgen_Shift_Right (Left, Right : Integer_32) return Integer_32;

   function Isfinite (F : Float) return Boolean;
   function Isfinite (F : Long_Float) return Boolean;

   function Getinf return Long_Float;

   function Isinf (F : Float) return Boolean;
   function Isinf (F : Long_Float) return Boolean;

   function Isnan (F : Float) return Boolean;
   function Isnan (F : Long_Float) return Boolean;
end Qgen_Functions;
